...
<\/script>
`)],-1)),s(r,{right:""}),e[7]||(e[7]=l(`<h2 id="states" tabindex="-1">States <a class="header-anchor" href="#states" aria-label="Permalink to &quot;States&quot;">​</a></h2><h3 id="is-open" tabindex="-1">is-open <a class="header-anchor" href="#is-open" aria-label="Permalink to &quot;is-open&quot;">​</a></h3><p>Determines is the drawer is opened or closed.</p><pre><code>&lt;div id=&quot;sidebar&quot; class=&quot;c-drawer is-open&quot;&gt;&lt;/div&gt;
</code></pre><h2 id="notes" tabindex="-1">Notes <a class="header-anchor" href="#notes" aria-label="Permalink to &quot;Notes&quot;">​</a></h2><p>Wisp does not ship with a JavaScript library or make opinions on how you should implement this in your projects.</p>`,6))])}const v=n(p,[["render",c]]);export{f as __pageData,v as default};
